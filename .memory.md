...
> **Config**: Zie `opencode.config.yaml` voor feature toggles en plugin configuratie.
...
Bij vragen over een GitHub repo:

1. Gebruik GitHub CLI (`gh`)
2. Clone repo tijdelijk naar `/tmp` map
3. Analyseer de code lokaal
4. Voorbeeld: `gh repo clone owner/repo /tmp/repo-analysis`
