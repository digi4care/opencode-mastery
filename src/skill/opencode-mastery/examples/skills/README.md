...
| ----- | --------------- | ----------------- | --------------------------------- | ---------------------------- | -------------- |
| **1** | `minimal/`      | ⭐ Minimal        | 1 (SKILL.md)                      | Proof of Concept, Quick Demo | 5 minutes      |
| **2** | `intermediate/` | ⭐⭐ Intermediate | 2 (SKILL.md + script)             | Helper Scripts, Multi-Step   | 15 minutes     |
| **3** | `advanced/`     | ⭐⭐⭐ Advanced   | 7 (SKILL.md + config + 5 scripts) | Full Workflow, Config-Driven | 30+ minutes    |
...
- [minimal/](./minimal/) - Basic skill structure
- [intermediate/](./intermediate/) - Helper script integration
- [advanced/](./advanced/) - Config-driven workflows
...
- [plugins/README.md](../plugins/README.md) - Complete plugin guide
- [plugins/minimal/](../plugins/minimal/) - Tier 1 example
- [plugins/intermediate/](../plugins/intermediate/) - Tier 2 example
- [plugins/advanced/](../plugins/advanced/) - Tier 3 example
