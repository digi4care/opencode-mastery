...
- [Upgrade Your Project](#upgrade-your-project)
  ...
  - [2. Replace PostCSS with Vite](#2.-replace-postcss-with-vite)
    - [Delete postcss.config.js](#delete-postcss.config.js)
    - [Uninstall @tailwindcss/postcss](#uninstall-@tailwindcss/postcss)
    - [Install @tailwindcss/vite](#install-@tailwindcss/vite)
    - [Update vite.config.ts](#update-vite.config.ts)
    - [Verify the upgrade](#verify-the-upgrade)
  - [2. Update your app.css file](#2.-update-your-app.css-file)
    ...
    - [Remove the tailwind.config file](#remove-the-tailwind.config-file)
...
```jsx
<script lang="ts">
  - import type {WithElementRef} from "bits-ui"; + import type {WithElementRef} from
  "$lib/utils.js";
</script>
```
